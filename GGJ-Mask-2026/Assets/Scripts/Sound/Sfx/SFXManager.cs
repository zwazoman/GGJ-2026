...
public class SFXManager : MonoBehaviour
{
    ...
    /// <summary>
    /// r�cup�re une audioSource dans la pool et joue un des sons possibles
    /// </summary>
    ...
    /// <summary>
    /// r�cup�re une audioSource dans la pool et joue le son donn�
    /// </summary>
    /// <param name="choosenSound"></param>
    ...
    /// <summary>
    ///joue un son. le son sera plac� a un endroit donn� et prendra en compte ou non les effets.
    /// </summary>
    /// <param name="choosenSound"></param>
    /// <param name="position"></param>
    /// <param name="bypassesEffects"></param>
    ...
    /// <summary>
    /// g�re les r�gales de l'audiosource et joue le son.
    /// </summary>
    ...
    AudioSource AudioSourceHandle(AudioSource audioSource, float volume = 1, float pitch = 1, bool is2D = true, bool bypassesEffects = false, AudioMixerGroup choosenMixerGroup = null)
    {
        ...
        if (!is2D) audioSource.spatialBlend = 1; // g�re bien le blend rapport a l'audiolistener
    ...
    /// <summary>
    /// choisit un clip random dans le clip donn�. trueRandom d�fini si oui ou non, la liste devra-t-�tre parcourue enti�rement avant de se r�p�ter
    /// </summary>
